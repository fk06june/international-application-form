...
Après sélection, le formulaire interroge OpenAlex avec le code ISO du pays : `https://api.openalex.org/institutions?filter=type:education,country_code:XX&per-page=100`. Les résultats sont lus dans `results` et affichent le champ `display_name`.
